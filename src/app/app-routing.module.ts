...
import { Cat1Page1Component } from "./pages/cat1-page1/cat1-page1.component";
...
import { SubItemPage2Component } from "./pages/sub-item-page2/sub-item-page2.component";
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: "subItem_1_2",
                        component: SubItemPage2Component,
                    },
                ],
            },
            {
